      ...
      <section className="w-full rounded-2xl border border-gray-200 bg-white p-6 shadow-sm sm:p-10">
        ...
        {!lookupComplete ? (
          ...
          <div className="space-y-5 text-gray-700">
            ...
            <div className="rounded-xl bg-primary-50 p-4 text-sm leading-relaxed">Approval permits us to operate the learner account, store profile and study activity, provide practice and progress features, and apply security controls. AI chat sends relevant prompts and context to OpenAI; that permission is separate below. A school is not given access by this approval.</div>
            ...
            <p className="text-sm">You can later withdraw authorisation or request deletion by emailing <a className="font-semibold text-primary-700 hover:underline" href="mailto:privacy@studybuddyng.com">privacy@studybuddyng.com</a>. We will verify your identity and authority before acting.</p>
