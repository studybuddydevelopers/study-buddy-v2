...
| [`PROCESSOR_AND_VENDOR_REGISTER.md`](/Users/efeon/study-buddy-v2/docs/compliance/PROCESSOR_AND_VENDOR_REGISTER.md) | Initial register for Supabase, OpenAI, Meta, Paystack, Railway, Cloudflare, CAPTCHA, email and source-control providers; Railway's DPA is fully executed and privately retained | Complete company-account identity and agreement evidence for the other providers, then verify production regions, sub-processors, retention and transfer safeguards |
...
- [x] Confirm the four other refund grounds: duplicate payment, paid service not
  provided, Study Buddy discontinuation, and Nigerian-law requirements.
- [ ] Implement the approved renewal, cancellation and refund operations before
  paid launch.
