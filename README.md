...
| [`DATA_RETENTION_AND_DELETION_SCHEDULE.md`](/Users/efeon/study-buddy-v2/docs/compliance/DATA_RETENTION_AND_DELETION_SCHEDULE.md) | Data-category inventory, deletion steps, legal-hold rules, 36-month deactivated-account expiry with four notices, and email-confirmed deletion with a 15-day cancellation window | Other periods need legal/finance approval; chat-only hard purge, cloud-draft expiry, and provider backup configuration still need completion |
...
- [ ] Configure Railway to call the account-lifecycle cron at least hourly.
